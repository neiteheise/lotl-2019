...
class SecurityController: UIViewController {
    ...
    func content(){
        ...
        let image = #imageLiteral(resourceName: "eventmap1")
        let imageView = UIImageView(image: image)
        ...
        let image2 = #imageLiteral(resourceName: "eventmap2")
        let imageView2 = UIImageView(image: image2)
        
        let iWidth2 = scrollView.frame.width + 12
        let iHeight2 = scrollView.frame.width * 1.926
        let iX2 = scrollView.frame.minX
        let iY2 = scrollView.frame.minY + imageView.frame.size.height
        imageView2.sizeToFit()
        imageView2.frame = CGRect(x: iX2 - 7, y: iY2 - 15, width: iWidth2, height : iHeight2)
        imageView2.contentMode = .scaleAspectFill
        scrollView.addSubview(imageView2)
        
        scrollView.contentSize = CGSize(width: swidth, height: iHeight2 + iHeight + swidth / 2)
    }
