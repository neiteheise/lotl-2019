//
//  ENormsController.swift
//  LOTL_ed1
//
//  Created by Nathan Hellmuth on 8/2/19.
//  Copyright © 2019 Lighting of the Lawn. All rights reserved.
//

import UIKit

class ENormsController: UIViewController {
    ...
    func content(){
        ...
        let image = #imageLiteral(resourceName: "eventnormsfinalpart1")
        let imageView = UIImageView(image: image)
        ...
        let image2 = #imageLiteral(resourceName: "eventnormsfinalpart2")
        let imageView2 = UIImageView(image: image2)
        
        let iWidth2 = scrollView.frame.width
        let iHeight2 = scrollView.frame.width * 2
        ...
        imageView2.frame = CGRect(x: iX2, y: iY2, width: iWidth2, height : iHeight2)
        imageView2.contentMode = .scaleAspectFill
        scrollView.addSubview(imageView2)
        scrollView.contentSize = CGSize(width: swidth, height: iY2+iHeight + 20)
    }
